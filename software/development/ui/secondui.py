...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.add_btn.setGeometry(QtCore.QRect(400, 100, 121, 60))
        font = QtGui.QFont()
        ...
        self.back_btn.setGeometry(QtCore.QRect(400, 180, 121, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.pushButton.setGeometry(QtCore.QRect(400, 260, 121, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(400, 340, 121, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
