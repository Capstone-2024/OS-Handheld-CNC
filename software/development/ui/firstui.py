...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.setting_btn.setGeometry(QtCore.QRect(300, 60, 151, 55))
        font = QtGui.QFont()
        ...
        self.information_btn.setGeometry(QtCore.QRect(300, 120, 151, 55))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.start_btn.setGeometry(QtCore.QRect(300, 180, 151, 55))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.pushButton.setGeometry(QtCore.QRect(300, 260, 151, 55))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
