...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.setting_btn.setGeometry(QtCore.QRect(450, 100, 151, 55))
        font = QtGui.QFont()
        ...
        self.information_btn.setGeometry(QtCore.QRect(450, 180, 151, 55))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.start_btn.setGeometry(QtCore.QRect(450, 260, 151, 55))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.pushButton.setGeometry(QtCore.QRect(450, 340, 151, 55))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
