...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.setting_btn.setGeometry(QtCore.QRect(500, 100, 151, 55))
        font = QtGui.QFont()
        ...
        self.information_btn.setGeometry(QtCore.QRect(500, 180, 151, 55))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.start_btn.setGeometry(QtCore.QRect(500, 260, 151, 55))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.pushButton.setGeometry(QtCore.QRect(500, 340, 151, 55))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
