...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.setting_btn.setGeometry(QtCore.QRect(140, 20, 151, 31))
        font = QtGui.QFont()
        ...
        self.information_btn.setGeometry(QtCore.QRect(140, 60, 151, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.start_btn.setGeometry(QtCore.QRect(140, 100, 151, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
