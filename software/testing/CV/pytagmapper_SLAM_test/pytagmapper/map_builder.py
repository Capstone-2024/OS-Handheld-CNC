...
class MapBuilder:
    def __init__(self, camera_matrix, distortion_matrix, tag_side_lengths, map_type = "2d"):
    ...
    def add_viewpoint(self, viewpoint_id, tags, init_viewpoint = None, init_tags = None):
        ...
        if init_viewpoint is None:
            if not overlapping_tag_ids:
                ...
                tx_camera_world = solvePnPWrapper(tags_world_coords, tags_img_coords, self.camera_matrix, self.distortion_matrix)
        ...
        for tag_id in new_tag_ids:
            ...
            tx_camera_tag = solvePnPWrapper(corners_mat, detection, self.camera_matrix, self.distortion_matrix)
