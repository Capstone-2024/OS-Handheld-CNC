...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.add_btn.setGeometry(QtCore.QRect(120, 30, 121, 31))
        font = QtGui.QFont()
        ...
        self.back_btn.setGeometry(QtCore.QRect(120, 60, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.pushButton.setGeometry(QtCore.QRect(120, 90, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
